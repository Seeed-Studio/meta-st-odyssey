...
SRC_URI += "file://${LINUX_VERSION}/${LINUX_VERSION}.${LINUX_SUBVERSION}/0001-Modify-.dts-file-so-that-make-the-kernel-run-normall.patch \
            ...
            file://${LINUX_VERSION}/${LINUX_VERSION}.${LINUX_SUBVERSION}/0002-fix_usb_ethernet_bug.patch \
            file://${LINUX_VERSION}/${LINUX_VERSION}.${LINUX_SUBVERSION}/0003-fix-eth-reset-issue.patch \
